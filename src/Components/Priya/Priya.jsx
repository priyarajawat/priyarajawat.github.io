...
const Priya = () => {
  ...
  return (
   <SimpleGrid id="about" >
    ...
    <br/>
    <a target="_blank" href="https://drive.google.com/file/d/1TfuIthnlBAlvFDB4_O1EixS4AILDTmp0/view?usp=sharing" > <Button onClick={onButtonClick} id="resume" size={"sm"} m='auto'>RESUME</Button></a>
